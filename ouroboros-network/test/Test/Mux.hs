...
prop_demux_sdu a = do
  ...
  where
    ...
    run (ArbitraryValidSDU sdu state (Just Mx.MuxIngressQueueOverRun)) = do
        ...
        -- single segment.
        let serverApp = Mx.MuxServerApplication $ \ChainSyncSmall -> serverRsp stopVar
    ...
    run (ArbitraryValidSDU sdu state err_m) = do
        ...
        let serverApp = Mx.MuxServerApplication $ \ChainSync1 -> serverRsp stopVar
    ...
    plainServer serverApp = do
        ...
        said <- startMuxSTM serverApp server_w server_r 1280 Nothing
...
demo chain0 updates delay = do
    ...
    let Just expectedChain = Chain.applyChainUpdates updates chain0
        ...
        consumerApp :: Mx.MuxApplication Mx.ClientApp TestProtocols1 m
        ...
        producerApp :: Mx.MuxApplication Mx.ServerApp TestProtocols1 m
