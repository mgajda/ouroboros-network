...
-- | This is the type of the pipelined results, since this transaction
-- submission can pipeline requests for transaction ids and transactions,
-- so we use a sum of either.
--
